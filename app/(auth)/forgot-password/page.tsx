...
import axios from "axios";
import { API_URL } from "../../config/api";
import { FiMail, FiArrowLeft, FiShield, FiSend, FiLock, FiX, FiThumbsUp, FiAlertCircle } from "react-icons/fi";
import { MdOutlineAttachEmail } from "react-icons/md";
  ...
  const handleSubmit = async (e: FormEvent) => {
    ...
    try {
      ...
      showModal('success', {
        ...
        subMessage: "Please check your inbox and enter the code to reset your password.",
        email: email
      });
    } catch (err: unknown) {
      console.error("Error sending message:", err);
                    ...
                    <div className="flex gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-indigo-700 text-sm">
                          ...
                          <span className="font-medium">{modalConfig.email}</span>
                        </p>
                  ...
                  >
                    <button
                      onClick={() => {
                        ...
                        router.push(`/change-password?email=${encodeURIComponent(modalConfig.email)}`);
                      }}
