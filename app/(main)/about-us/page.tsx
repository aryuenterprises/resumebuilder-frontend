...
//               of the world's growing ed-tech platforms
//             </motion.p>
//             <motion.div
//               initial={{ opacity: 0, y: 20 }}
//               animate={{ opacity: 1, y: 0 }}
...
//                 PassATS is a product of Aryu Academy - an ed-tech platform that
//                 has been training students and working professionals globally in
//                 technology, digital marketing, and career-ready skills
//               </p>
//               <p className="text-sm sm:text-base text-gray-600 leading-relaxed">
//                 Aryu Academy was built on a single belief: that the gap between
//                 learning a skill and getting hired for it should not exist. Our
...
//                   completes a course at Aryu Academy, they need a resume that
//                   communicates their new skills clearly, gets past ATS, and
//                   lands them interviews - anywhere in the world. PassATS is that
//                   bridge
//                 </p>
//               </div>
//             </motion.div>
...
//                 </div>
//                 <div>
//                   <p className="text-[10px] sm:text-xs font-medium text-indigo-400">
//                     Comparison
//                   </p>
...
//                   >
//                     <span className="text-[10px] sm:text-xs text-gray-400 w-1/4">
//                       {item.feature}
//                     </span>
//                     <span className="text-[10px] sm:text-xs text-red-400 w-2/5 text-center">
//                       {item.other}
//                     </span>
//                     <span className="text-[10px] sm:text-xs text-green-400 w-2/5 text-right">
//                       {item.pass}
//                     </span>
//                   </div>
//                 ))}
...
//             " To empower every job seeker — regardless of location, background,
//             or education — to present their skills on a resume that gets through
//             ATS, gets read by recruiters, and gets them in the room "
//           </p>
//         </div>
//       </section>
...
//               <div
//                 key={idx}
//                 className="text-center p-5 sm:p-6 rounded-xl bg-gray-50"
//               >
//                 <div
//                   className={`w-10 h-10 sm:w-12 sm:h-12 rounded-xl ${value.bg} flex items-center justify-center mx-auto mb-3 sm:mb-4`}
//                 >
//                   <div className={value.color}>{value.icon}</div>
//                 </div>
...
//               <div
//                 key={idx}
//                 className="flex items-start gap-3 p-3.5 sm:p-4 rounded-xl border border-gray-100 bg-gray-50"
//               >
...
//                 <div
//                   className={`w-11 h-11 sm:w-14 sm:h-14 md:w-16 md:h-16 rounded-xl sm:rounded-2xl ${item.bg} flex items-center justify-center mb-3 sm:mb-4 md:mb-5 shadow-lg group-hover:scale-110 transition-transform duration-300`}
//                 >
...
//                 {/* Content */}
//                 <h3 className="font-bold text-gray-900 text-base sm:text-lg md:text-xl mb-1 sm:mb-2">
//                   {item.title}
//                 </h3>
...
//                 <p className="text-gray-500 text-[10px] sm:text-xs md:text-sm mt-1 sm:mt-2">
//                   {item.description}
//                 </p>
...
//             Join job seekers across the globe who are using PassATS to get past
