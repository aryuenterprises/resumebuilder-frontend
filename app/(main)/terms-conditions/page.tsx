  ...
  const sections = [
    ...
    },
    {
      ...
      content: `PassATS is an AI-powered online resume builder accessible at passats.aryuacademy.com. The Service allows users to create, edit, download, and share professional resumes using AI writing assistance, ATS optimisation tools, and professionally designed templates.
        ...
        Features available to you depend on your subscription plan (Free, Pro or Premium). We reserve the right to add, modify, or remove features at any time with reasonable notice.`,
    },
    {
      id: 3,
      ...
      content: `To access most features of the Service, you must create a user account. You are responsible for:
        ...
        • Notifying us immediately at passats@aryuacademy.com if you suspect unauthorised access to your account
    ...
    },
    {
      ...
      content: `PassATS offers the following subscription plans:
        ...
        • Pro: ₹99/month — 3 templates, AI suggestions, ATS optimisation, photo upload
        • Lifetime: ₹249 one-time payment — all templates, unlimited AI, interview prep kit, no renewal
    ...
    },
    {
      ...
      title: "Refund Policy",
      content: `We want you to be satisfied with PassATS. If you are not happy with your paid plan, you may request a full refund within 7 days of your initial purchase or renewal by contacting us at passats@aryuacademy.com.
    ...
    },
    {
      ...
      content: `These Terms are governed by the laws of India. Any dispute arising from these Terms or your use of the Service shall be subject to the exclusive jurisdiction of the competent courts in Chennai, Tamil Nadu, India.
        ...
        Before pursuing formal legal action, we encourage you to contact us at passats@aryuacademy.com to resolve disputes amicably.
