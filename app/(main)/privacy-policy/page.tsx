  ...
  const sections = [
    ...
    },
    {
      ...
      content: `You have the following rights with respect to your personal data:
        ...
        To exercise any of these rights, please contact us at passats@aryuacademy.com. We will respond within 15 business days.`,
    },
    {
      id: 6,
    ...
    },
    {
      ...
      content: `PassATS is not intended for users under the age of 13. We do not knowingly collect personal information from children under 13. If you believe a child has provided us with personal information, please contact us at passats@aryuacademy.com and we will promptly delete it.`,
    },
    {
      id: 8,
      icon: <FiLock className="w-4 h-4 sm:w-5 sm:h-5" />,
