...
//           color: "from-slate-500 to-slate-700", // Sleek gray
...
export default function ChoosePlanPage() {
  ...
  const handleSelectPlan = async (plan: Plan) => {
    if (plan.price === 0) {
      ...
      try {
        ...
        // payment-razor/payment-all-records?userId=6997f1542bca7f0b01465d8a
        ...
        Swal.fire("Error", "Failed to activate free plan", "error");
      } finally {
        setLoading(false);
      }
    } else {
  ...
  const handlePaymentSuccess = () => {
    // Refresh user subscription data or redirect
              ...
              >
                ...
                <div
                  className={`
                    ...
                    ${
                      plan.popular
                        ? "shadow-xl border-2 border-[#C40116]"
