              ...
              <div className="relative">
                <div className="flex justify-between items-start gap-2">
                  <div className="flex-1">
                    ...
                    <p className="text-white/80 text-xs sm:text-sm">{plan.description}</p>
                  </div>
                  <button
                    onClick={onClose}
            ...
            <div className="p-5 sm:p-6">
              <div className="mb-5 sm:mb-6">
                <div className="flex items-baseline gap-2 mb-3 sm:mb-4">
                  ...
                  <span className="text-gray-500 text-xs sm:text-sm">/{plan.interval}</span>
                </div>
              ...
              <p className="text-[10px] sm:text-xs text-gray-500 text-center mt-3 sm:mt-4 flex items-center justify-center gap-1">
                <IoShieldCheckmark className="w-2.5 h-2.5 sm:w-3 sm:h-3" /> Secure payment powered by Razorpay
              </p>
            </div>
          </motion.div>
        </motion.div>
    ...
    <div className="min-h-screen bg-gradient-to-br from-indigo-50/30 via-white to-indigo-50/30">
      ...
      <div className="max-w-7xl mx-auto px-3 py-12 sm:py-16 lg:py-20">
                ...
                >
                    ...
                    <div className="relative">
                      ...
                      {isSamePlan && (
                        <span className="absolute top-0 right-0 px-1.5 sm:px-2 py-0.5 sm:py-1 bg-emerald-500/80 text-white text-[8px] sm:text-xs font-semibold rounded-full flex items-center gap-0.5 sm:gap-1">
                          <FiCheckCircle className="w-2 h-2 sm:w-3 sm:h-3" /> Active
                        </span>
                      )}
                    </div>
                  </motion.div>
                  ...
                  <div className="p-4 sm:p-5 md:p-6">
                    ...
                    {isSamePlan ? (
                      ...
                      >
                        <FiCheckCircle className="w-3 h-3 sm:w-3.5 sm:h-3.5" /> Current Plan
                      </motion.button>
                    ) : (
                      <motion.button
                        whileHover={{ scale: 1.02 }}
        ...
        <motion.div
          ...
          animate={{ opacity: 1, y: 0 }}
          transition={{ delay: 0.5, duration: 0.5 }}
          className="mt-12 sm:mt-16 lg:mt-20 grid grid-cols-1 sm:grid-cols-3 gap-3 sm:gap-4 md:gap-6"
        >
          {[
            {
              icon: FiUsers,
            ...
            <motion.div
              key={idx}
              whileHover={{ y: -3 }}
              className="bg-white rounded-xl sm:rounded-2xl p-4 sm:p-5 md:p-6 text-center border border-gray-100 shadow-md hover:shadow-lg transition-all duration-300 cursor-pointer"
            >
              <motion.div
                className={`w-10 h-10 sm:w-11 sm:h-11 md:w-12 md:h-12 ${stat.bg} rounded-lg sm:rounded-xl flex items-center justify-center mx-auto mb-2 sm:mb-3`}
                whileHover={{ rotate: 5, scale: 1.05 }}
              >
                <stat.icon className={`w-5 h-5 sm:w-5.5 sm:h-5.5 md:w-6 md:h-6 ${stat.text}`} />
              </motion.div>
              <motion.p
              ...
              <p className="text-[11px] sm:text-xs md:text-sm text-gray-500">{stat.label}</p>
            </motion.div>
          ))}
        </motion.div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-3 sm:gap-4 md:gap-5">
            {faqs.map((faq, idx) => (
              <motion.div
                ...
                transition={{ delay: 0.8 + idx * 0.05 }}
                whileHover={{ y: -2 }}
                className="bg-white rounded-lg sm:rounded-xl p-4 sm:p-5 md:p-6 border border-gray-100 hover:shadow-md transition-all duration-300 cursor-pointer"
              >
                <h3 className="font-semibold text-gray-900 mb-1.5 sm:mb-2 flex items-center gap-1.5 sm:gap-2 text-sm sm:text-base">
                  <FiAward className="w-4 h-4 sm:w-5 sm:h-5 text-indigo-500" /> {faq.q}
                </h3>
