...
//                       className="w-full sm:w-fit px-4 py-3 sm:px-5 sm:py-3.5 bg-linear-to-r from-[#C40116] to-[#5E000B] hover:from-[#5E000B] hover:to-[#C40116] text-white font-semibold rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 flex items-center justify-center gap-2 text-sm sm:text-base"
//                     >
