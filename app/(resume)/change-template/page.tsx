...
//                     className={
//                       isMobile
//                         ? "p-3 sm:p-4 overflow-y-auto h-[calc(100vh-70px)]"
//                         : ""
//                     }
//                   >
...
//                           const requiredPlan =
//                             getRequiredPlanForTemplate(index);
...
//                                     {isPremium ? (
//                                       <span
//                                         className={`px-1 sm:px-1.5 py-0.5 ${PLAN_CONFIG[requiredPlan].badgeColor} rounded-full text-[8px] sm:text-[10px] font-medium flex items-center gap-0.5 sm:gap-1`}
//                                       >
...
//                                         )}
//                                         <span className="max-xs:hidden xs:inline">
//                                           {requiredPlanLabel}
//                                         </span>
//                                       </span>
//                                     ) : (
...
//                             return (
//                               <div
//                                 className={`px-1.5 sm:px-2 py-0.5 rounded-full text-[8px] sm:text-[10px] font-medium flex items-center gap-0.5 sm:gap-1 ${
//                                   isAccessible
//                                     ? requiredPlan === "free"
...
//                               <>
//                                 Use This Template{" "}
//                                 <FiChevronRight className="w-3 h-3 sm:w-3.5 sm:h-3.5" />
//                               </>
//                             ) : (
//                               <>
//                                 Upgrade to Use{" "}
...
// ============================================================
// OPTIMIZED: Template Card Component (Memoized)
// ============================================================
        ...
        <div className="flex items-start gap-2 sm:gap-3 p-2 sm:p-3">
          ...
          <div className="flex-1 min-w-0">
            <div className="flex items-center justify-between gap-1 sm:gap-2 mb-0.5 sm:mb-1">
              ...
              {isPremium ? (
                <span
                  className={`px-1 sm:px-1.5 py-0.5 ${PLAN_CONFIG[requiredPlan as keyof typeof PLAN_CONFIG].badgeColor} rounded-full text-[8px] sm:text-[10px] font-medium flex items-center gap-0.5 sm:gap-1`}
                >
                  {requiredPlan === "premium" ? (
                    <Crown className="w-2 h-2 sm:w-2.5 sm:h-2.5" />
                  ) : (
...
// ============================================================
// OPTIMIZED: Fullscreen Preview Component (Memoized)
// ============================================================

const FullscreenPreview = React.memo(
  ({
    previewTemplate,
    isFullscreen,
    zoom,
    ...
    if (!isFullscreen || !previewTemplate) return null;
...
export default function ChangeTemplate() {
  ...
  // ============================================================
  // OPTIMIZATION: React Query for user data
  // ============================================================
  ...
  // ============================================================
  // OPTIMIZATION: Process user data
  // ============================================================

  useEffect(() => {
    if (userData?.subscription) {
      setUsersCurrentPlan(userData.subscription.current_plan.toLowerCase());
    }
  }, [userData]);
  ...
  const availableTemplates = useMemo((): number => {
    const maxTemplates = PLAN_CONFIG[currentPlan].maxTemplates;
    return Math.min(maxTemplates, templateData.length);
  }, [currentPlan]);
  ...
  const getTemplateIndex = useCallback((templateId: number): number => {
    return templateData.findIndex((t) => t.id === templateId);
  }, []);
  ...
  // ============================================================
  // OPTIMIZATION: Memoize animation variants
  // ============================================================
