...
//   const handleSubmitAi = async (prompt?: string) => {
...
//   // Handler for opening prompt panel (with validation)
...
//                             e.g., Focus on cloud, DevOps, and modern frontend
//                             frameworks relevant to my experience.
//                           </p>
//                         </div>
//                       </div>
...
//                           </button>
//                           <button
//                             onClick={() => handleSubmitAi(userPrompt)}
...
//                                 : "bg-gradient-to-r from-indigo-600 to-indigo-500 text-white hover:shadow-md cursor-pointer"
//                             }`}
//                             type="button"
//                           >
//                             <svg
...
const SkillsForm = () => {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-gradient-to-br from-slate-50 via-white to-indigo-50/40">
      ...
      <div className="flex-1 overflow-y-auto">
        <div className="mx-auto px-3 sm:px-4 lg:px-2 py-4 sm:py-6 lg:py-10">
          ...
          <div className="text-center mb-4 sm:mb-6 lg:mb-8">
            <h1 className="text-xl sm:text-2xl md:text-3xl lg:text-4xl font-bold bg-gradient-to-r from-indigo-600 via-purple-600 to-indigo-600 bg-clip-text text-transparent mb-1.5 sm:mb-2">
              Skills & Expertise
            </h1>
            ...
            <button
              onClick={() => setSkillTipsClicked(true)}
              className="mt-3 sm:mt-4 inline-flex items-center gap-1 sm:gap-1.5 px-3 sm:px-4 py-1 sm:py-1.5 bg-gradient-to-r from-amber-400 to-orange-400 text-white rounded-full text-[11px] sm:text-xs font-semibold shadow-md hover:shadow-lg transition-all duration-200"
            >
          ...
          <div className="bg-white rounded-2xl sm:rounded-3xl shadow-xl border border-gray-100 overflow-hidden">
            {/* Card Header */}
            <div className="relative px-3 sm:px-6 lg:px-8 py-3 sm:py-5 lg:py-6 bg-gradient-to-r from-indigo-50 to-white border-b border-gray-100">
              ...
              <div className="relative flex flex-col sm:flex-row sm:items-center justify-between gap-2 sm:gap-3">
                ...
                <div className="flex items-center gap-2">
                  {isSaving && (
                    <div className="flex items-center gap-1.5 sm:gap-2 px-2 sm:px-3 py-1 sm:py-1.5 bg-indigo-100 rounded-full">
                      <div className="w-2 h-2 sm:w-3 sm:h-3 border-2 border-indigo-600 border-t-transparent rounded-full animate-spin" />
                      <span className="text-[10px] sm:text-xs text-indigo-700 font-medium">
                        Saving...
                      </span>
            ...
            <div className="p-3 sm:p-6 lg:p-8">
              {/* Action Buttons */}
              <div className="flex flex-wrap justify-end items-center gap-2 sm:gap-3 mb-3 sm:mb-4">
                {/* Custom Prompt Toggle Button */}
                <div className="relative inline-block group">
                  <button
                    onClick={handleOpenPrompt}
                ...
                <div className="relative inline-block group">
                  <button
                    ...
                    disabled={loading}
                    className={`flex items-center cursor-pointer justify-center gap-1.5 sm:gap-2 px-3 sm:px-4 py-1.5 sm:py-2 bg-gradient-to-r from-indigo-600 to-indigo-500 text-white rounded-lg text-[11px] sm:text-sm font-medium hover:shadow-lg transition-all ${
                      experienceTitlesList.length === 0
                        ? "cursor-not-allowed opacity-50"
                        : ""
                    }`}
          ...
          <div className="flex justify-between items-center gap-2 sm:gap-4">
            ...
            >
              ...
              <div className="relative flex items-center justify-center gap-1.5 sm:gap-2">
                <span className="hidden xs:inline">Continue to Projects</span>
              ...
              <div className="flex flex-wrap gap-1.5 sm:gap-2 mb-4">
                {Airesponse.map((skill, index) => (
                  <motion.button
                    ...
                    transition={{ delay: index * 0.05 }}
                    onClick={() => insertAIResponse(skill, index)}
                    className="px-2.5 sm:px-3 py-1.5 bg-gray-100 text-gray-700 rounded-full text-xs sm:text-sm hover:bg-indigo-500 hover:text-white transition-all cursor-pointer"
                  >
                    {skill}
                  </motion.button>
                ))}
      ...
      {/* Mobile Warning Modal */}
      {showMobileWarning && (
        <div className="fixed inset-0 z-[99999] flex items-center justify-center p-3 sm:p-4 bg-black/50 md:hidden">
          <div className="bg-white rounded-xl p-4 sm:p-6 max-w-sm w-full mx-auto shadow-xl">
            <div className="flex items-center gap-2.5 sm:gap-3 mb-3 sm:mb-4">
              <div className="w-9 h-9 sm:w-10 sm:h-10 bg-amber-100 rounded-full flex items-center justify-center shrink-0">
                <svg
