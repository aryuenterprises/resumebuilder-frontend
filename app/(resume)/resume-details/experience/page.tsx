...
//                                           e.g., Highlight leadership impact,
//                                           quantifiable results, and key
//                                           technologies used.
//                                         </p>
//                                       </div>
//                                     </div>
        ...
        <div className="mx-auto px-3 sm:px-4 lg:px-2 py-4 sm:py-6 lg:py-10">
          ...
          <div className="bg-white rounded-2xl sm:rounded-3xl shadow-xl border border-gray-100 overflow-hidden">
            ...
            <div className="p-3 sm:p-6 lg:p-8">
              {/* Experience Toggle */}
              <div className="flex items-center gap-2.5 sm:gap-4 mb-4 sm:mb-6 lg:mb-8">
                <div
                  onClick={toggleExperienceMode}
                  className={`relative w-10 h-5 sm:w-12 sm:h-6 rounded-full cursor-pointer transition-all duration-300 ${
                    isExperienced
                            ...
                            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-5">
                              ...
                              <div>
                                ...
                                <input
                                  ...
                                  disabled={exp.isCurrentlyWorking}
                                  className={`w-full px-3 sm:px-4 py-2 sm:py-3 bg-white border-2 rounded-lg sm:rounded-xl text-gray-900 text-sm focus:outline-none focus:border-indigo-500 focus:ring-2 focus:ring-indigo-100 transition-all ${
                                    exp.isCurrentlyWorking
                                      ? "border-gray-200 bg-gray-50 text-gray-400 cursor-not-allowed"
                                      : "border-gray-200"
                                  }`}
          ...
          <div className="flex justify-between items-center gap-2 sm:gap-4">
            ...
            >
              ...
              <div className="relative flex items-center justify-center gap-1.5 sm:gap-2">
                <span className="hidden xs:inline">Continue to Education</span>
