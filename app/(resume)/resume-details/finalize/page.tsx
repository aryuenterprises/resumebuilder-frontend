...
const FinalizeForm = () => {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-linear-to-br from-slate-50 via-white to-indigo-50/40">
      ...
      <div className="flex-1 overflow-y-auto">
        <div className="container mx-auto px-3 sm:px-4 lg:px-2 py-4 sm:py-6 lg:py-10">
          {/* Header */}
          <div className="text-center mb-4 sm:mb-6 md:mb-8 lg:mb-10">
            <div className="inline-flex items-center gap-1 sm:gap-1.5 px-2 sm:px-3 py-0.5 sm:py-1.5 bg-indigo-100 rounded-full text-indigo-700 text-[9px] sm:text-xs font-semibold mb-2 sm:mb-3">
              <IoSparkles className="w-2.5 h-2.5 sm:w-3 sm:h-3" />
              <span>FINAL STEP</span>
              <IoSparkles className="w-2.5 h-2.5 sm:w-3 sm:h-3" />
            </div>

            <h1 className="text-lg sm:text-2xl md:text-3xl lg:text-4xl font-bold bg-linear-to-r from-indigo-600 via-purple-600 to-indigo-600 bg-clip-text text-transparent mb-1.5 sm:mb-2 px-3 sm:px-4">
              Additional Information
            </h1>

            <p className="text-[11px] sm:text-sm text-gray-500 max-w-md mx-auto px-3 sm:px-4">
              Add custom sections to make your resume stand out
            </p>

            <button
              onClick={() => setShowTips(true)}
              className="mt-2.5 sm:mt-4 inline-flex items-center gap-1 sm:gap-1.5 px-2.5 sm:px-4 py-1 sm:py-1.5 bg-linear-to-r from-amber-400 to-orange-400 text-white rounded-full text-[10px] sm:text-xs font-semibold shadow-md hover:shadow-lg transition-all"
            >
              <FaRegLightbulb className="w-2.5 h-2.5 sm:w-3 sm:h-3" />
              <span>Section Tips</span>
            </button>
          ...
          {/* Custom Sections */}
          <div className="bg-white rounded-xl sm:rounded-2xl md:rounded-3xl shadow-xl border border-gray-100 overflow-hidden">
            <div className="px-3 sm:px-6 lg:px-8 py-3 sm:py-4 lg:py-6 bg-linear-to-r from-indigo-50 to-white border-b border-gray-100">
              <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2 sm:gap-3">
                <div className="flex items-center gap-2 sm:gap-3">
                  <div className="p-1.5 sm:p-2 bg-indigo-100 rounded-lg">
                    <BsFileEarmarkText className="w-3.5 h-3.5 sm:w-5 sm:h-5 text-indigo-600" />
                  </div>
                  <div>
                    <h2 className="text-sm sm:text-base font-semibold text-gray-900">
                      Custom Sections
                ...
                {isSaving && (
                  <div className="flex items-center gap-1.5 sm:gap-2 px-2 sm:px-3 py-1 bg-indigo-100 rounded-full self-start sm:self-auto">
                    <div className="w-1.5 h-1.5 border-2 border-indigo-600 border-t-transparent rounded-full animate-spin" />
                    <span className="text-[10px] text-indigo-700 font-medium">
                      Saving...
                    </span>
            ...
            <div className="p-3 sm:p-6 lg:p-8">
              {customSections.length === 0 ? (
                <div className="text-center py-8 sm:py-12 bg-gray-50 rounded-xl">
                  <BsFileEarmarkText className="w-10 h-10 sm:w-12 sm:h-12 text-gray-300 mx-auto mb-2.5 sm:mb-3" />
                  <p className="text-gray-400 text-xs sm:text-sm mb-3 sm:mb-4">
                    No custom sections added yet
                  </p>
                  <button
                    onClick={addCustomSection}
                    className="inline-flex items-center gap-1.5 sm:gap-2 px-3 sm:px-4 py-2 rounded-lg bg-indigo-50 text-indigo-600 font-medium hover:bg-indigo-100 transition-all text-xs sm:text-sm"
                  >
                ...
                <div className="space-y-3 sm:space-y-4">
                  {customSections.map((section) => (
                    ...
                    >
                      {/* Accordion Header */}
                      <div
                        className="flex justify-between items-center cursor-pointer p-3.5 sm:p-4 hover:bg-gray-50 transition-colors"
                        onClick={() => toggleSection(section.id!)}
                        draggable={true}
                        onDragStart={(e) => handleDragStart(e, section.id!)}
                        onDragEnd={handleDragEnd}
                      ...
                      >
                        ...
                        <div className="flex items-center gap-1.5 sm:gap-2 flex-shrink-0">
                          <button
                            ...
                            className="p-1.5 sm:p-2 rounded-lg bg-red-50 text-red-500 hover:bg-red-100 transition-all"
                            title="Delete section"
                          >
                      ...
                      <div
                        className={`transition-all duration-300 overflow-hidden ${expandedSections[section.id!] ? "max-h-[600px]" : "max-h-0"}`}
                      >
                        <div className="p-3.5 sm:p-4 space-y-3.5 sm:space-y-4 border-t border-gray-100 bg-gray-50/30">
                          <div>
                            ...
                            <input
                              ...
                              placeholder="e.g., Volunteer Work, Publications, Certifications"
                              className="w-full px-3 sm:px-4 py-2 sm:py-2.5 bg-white border-2 border-gray-200 rounded-lg text-sm focus:outline-none focus:border-indigo-500 transition-all"
                            />
                          </div>
                          <div>
                            <label className="block text-[10px] sm:text-xs font-semibold uppercase tracking-wider text-gray-500 mb-1.5 sm:mb-2">
                  ...
                  {canAddMore() && (
                    <button
                      onClick={addCustomSection}
                      className="w-full flex items-center justify-center gap-1.5 sm:gap-2 px-3 sm:px-4 py-2.5 sm:py-3 rounded-lg bg-indigo-50 text-indigo-600 font-medium hover:bg-indigo-100 transition-all text-xs sm:text-sm mt-3 sm:mt-4"
                    >
                      <FaPlus className="w-3.5 h-3.5 sm:w-4 sm:h-4" />
                      Add Another Section
                    </button>
      ...
      {loading && (
        <div className="fixed inset-0 bg-black/60 backdrop-blur-md flex items-center justify-center z-50 p-4">
          <div className="bg-white rounded-xl p-5 sm:p-6 text-center max-w-sm w-full">
            <div className="w-9 h-9 sm:w-10 sm:h-10 border-3 border-indigo-600 border-t-transparent rounded-full animate-spin mx-auto mb-3"></div>
        ...
        {showAtsModal && (
          <>
            ...
            <motion.div
              ...
              animate={{ opacity: 1, scale: 1 }}
              exit={{ opacity: 0, scale: 0.9 }}
              className="fixed inset-0 flex items-center justify-center z-80 p-3 sm:p-4 pointer-events-none"
            >
              <div className="bg-white rounded-xl sm:rounded-2xl shadow-2xl max-w-md w-full pointer-events-auto">
                <div className="bg-linear-to-r from-indigo-600 to-purple-600 px-4 sm:px-6 py-3 sm:py-4 rounded-t-xl sm:rounded-t-2xl">
                ...
                <div className="p-4 sm:p-6 text-center">
                  ...
                  {showGrade && (
                    <>
                      <span
                        className={`inline-flex items-center gap-1 sm:gap-1.5 px-2.5 sm:px-3 py-1 sm:py-1.5 rounded-full text-[11px] sm:text-xs font-semibold mb-3 sm:mb-4
                        ${
                          progress >= 85
                            ? "bg-green-100 text-green-700"
                            : progress >= 70
                      ...
                      <div className="p-2.5 sm:p-3 bg-gray-50 rounded-lg mb-4 sm:mb-5">
                      ...
                      <div className="flex flex-col sm:flex-row gap-2.5 sm:gap-3">
                        <button
                          onClick={() => setShowAtsModal(false)}
                          className="flex-1 py-2 border-2 border-gray-200 text-gray-700 font-medium rounded-lg hover:bg-gray-50 transition-all text-xs sm:text-sm"
                        >
                          Close
                        </button>
                      </div>
