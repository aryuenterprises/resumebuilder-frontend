...
const TemplateSwitcher: React.FC<{
  ...
  const handleKeyDown = (e: KeyboardEvent<HTMLDivElement>, t: Template, isAccessible: boolean) => {
        ...
        return (
          <div
            ...
            className={`w-full flex items-start gap-3 p-2 rounded-xl border transition-all select-none text-left ${
              isAccessible ? "cursor-pointer" : "cursor-not-allowed opacity-60 bg-gray-50 border-gray-200"
            } ${
            ...
            <div className="flex-1 min-w-0 pointer-events-none">
              ...
              <p
                className={`text-xs font-semibold truncate ${
                  isSelected && isAccessible ? "text-indigo-700" : "text-gray-800"
                }`}
              >
                {t.style}
              </p>
