...
import { FiUpload, FiDownload, FiCheck, FiBarChart2 } from "react-icons/fi";
    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12 md:py-16">
      <div className="text-center mb-6 sm:mb-8 md:mb-10">
        ...
        <p className="mt-2 sm:mt-3 text-xs sm:text-sm md:text-base text-gray-500 max-w-2xl mx-auto px-4">
          Experience the magic of our AI as it analyzes, enhances, and optimizes
...
const CompleteAnimation = () => (
  ...
  >
    ...
    <p className="text-white mt-3 sm:mt-4 font-medium text-xs sm:text-sm md:text-base text-center">
      Ready to Apply!
    </p>
    <p className="text-gray-400 text-[10px] sm:text-xs text-center">
