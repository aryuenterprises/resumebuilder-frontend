    ...
    <section className="relative h-auto md:min-h-screen flex items-center justify-center overflow-hidden px-4 sm:px-6 lg:px-8 py-12  sm:py-16 md:py-20">
      <div className="relative z-10 text-center w-full max-w-7xl mx-auto">
        ...
        >
          ...
          understands the Global job market. Backed by Aryu Academy - trusted by
          students and professionals across Global
        </motion.p>
        ...
        <motion.div
          ...
          className="flex flex-col sm:flex-row items-center justify-center gap-3 sm:gap-4 md:gap-5 mb-0 sm:mb-10 md:mb-12"
        >
          <motion.button
        ...
        <motion.div
          ...
          className="flex flex-wrap items-center justify-center gap-3 sm:gap-4 md:gap-6 max-sm:hidden"
        >
          {stats.map((stat, idx) => (
            <div
              key={idx}
