...
const TemplateTen: React.FC<TemplateTenProps> = ({
  ...
  const buildCSS = useCallback((fontFamily: string) => {
    ...
    *, *::before, *::after { box-sizing: border-box; }
    ...
    .t10-resume p { margin: 0 !important; padding: 0 !important; line-height: 1.5 !important; }
    ...
    @media print {
      *, *::before, *::after { -webkit-print-color-adjust: exact !important; print-color-adjust: exact !important; }
      ...
      .t10-resume { width: 100% !important; padding: 0 !important; }
      .project-link, .header-meta-item a { color: #111 !important; text-decoration: underline !important; }
