...
//   const activeFontFamily = customization?.fontFamily ?? "-apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif";
//   const activeSectionOrder: SectionKey[] =
//     customization?.sectionOrder ?? [...DEFAULT_SECTION_ORDER];
...
//     };
//     // system font stack — no import needed
//     if (fontFamily.startsWith("-apple-system")) return "";
...
//       return `
//     ${fontImport ? `@import url('${fontImport}');` : ""}
...
//     /* ── RICH TEXT SHARED ──────────────────────────────────── */
//     .t3-summary ul, .t3-summary ol,
//     .t3-entry-content ul, .t3-entry-content ol,
//     .t3-project-description ul, .t3-project-description ol,
//     .t3-custom-section-content ul, .t3-custom-section-content ol,
//     .t3-skills-content ul, .t3-skills-content ol {
//       margin: 4px 0 4px 20px !important;
//       padding-left: 0 !important;
//     }
//     .t3-summary li, .t3-entry-content li, .t3-project-description li,
//     .t3-custom-section-content li, .t3-skills-content li {
//       margin-bottom: 2px !important;
//       line-height: 1.4 !important;
//     }
//     .t3-summary strong, .t3-entry-content strong, .t3-project-description strong,
//     .t3-custom-section-content strong, .t3-skills-content strong { font-weight: 700 !important; }
//     .t3-summary em, .t3-entry-content em, .t3-project-description em,
//     .t3-custom-section-content em, .t3-skills-content em { font-style: italic !important; }
//     .t3-summary u, .t3-entry-content u, .t3-project-description u,
//     .t3-custom-section-content u, .t3-skills-content u { text-decoration: underline !important; }
...
//     }
//     .t3-skills-content p { margin: 0 0 4px 0 !important; padding: 0 !important; line-height: 1.4 !important; }
...
//       font-size: 12px; color: #4b5563; white-space: nowrap; flex-shrink: 0;
//     }
...
//     .t3-project-description {
//       padding-top: 3px; color: #374151; font-size: 13px;
//       word-wrap: break-word; overflow-wrap: break-word;
//     }
...
//       // ── Header (always first, locked) ──────────────────────────────
//       const header = `
//       <div class="t3-header" data-block-id="header">
//         <div class="t3-header-left">
//           ${contact?.firstName || ""} ${contact?.lastName || ""}
//           ${contact?.jobTitle
//             ? `<div class="t3-header-job">${typeof contact.jobTitle === "string" ? contact.jobTitle : (contact.jobTitle as any)?.name || ""}</div>`
//             : ""}
//           <div class="t3-header-links">
//             ${linkedinUrl?.trim()  ? `<a href="${href(linkedinUrl)}"  class="t3-header-link" target="_blank">LinkedIn</a>`  : ""}
//             ${githubUrl?.trim()    ? `<a href="${href(githubUrl)}"    class="t3-header-link" target="_blank">GitHub</a>`    : ""}
...
//                    <div class="t3-project-item" data-block-id="proj-${i}">
//                      <div class="t3-project-header">
//                        <div class="t3-project-title">${p.title || ""}</div>
//                        <div class="t3-project-links">
//                          ${p.liveUrl   ? `<a href="${href(p.liveUrl)}"   class="t3-project-link" target="_blank">Live Demo</a>` : ""}
//                          ${p.githubUrl ? `<a href="${href(p.githubUrl)}" class="t3-project-link" target="_blank">GitHub</a>`   : ""}
//                        </div>
//                      </div>
//                      ${p.techStack?.length ? `<div class="t3-project-tech-stack"><strong>Tech:</strong> ${p.techStack.join(" • ")}</div>` : ""}
//                      ${p.description ? `<div class="t3-project-description">${rich(p.description)}</div>` : ""}
//                    </div>`).join("")}
//                </div>`
//             : "",
...
//                      <div class="t3-education-header">
//                        <div class="t3-education-school">${edu.schoolname || ""}</div>
//                        ${dateStr ? `<div class="t3-education-date">${dateStr}</div>` : ""}
//                      </div>
//                      <div class="t3-education-subtitle">${[edu.degree, edu.location].filter(Boolean).join(" — ")}</div>
//                      ${grade ? `<div class="t3-education-grade">${grade}</div>` : ""}
//                      ${edu.text ? `<div class="t3-entry-content">${rich(edu.text)}</div>` : ""}
//                    </div>`;
//                  }).join("")}
//                </div>`
...
//       let bodyContent = `${header}<div class="t3-body">${sectionsHTML}</div>`;
...
//               if (block.bottom <= currentStart) continue;
//               if (block.top >= currentStart && block.bottom > naiveCut) {
//                 if (block.top < actualCut) { actualCut = block.top; cutBlockId = block.id; }
//               }
//             }
...
//   // ── Download event listener (no inline button) ─────────────────────
//   useEffect(() => {
//     const handler = async () => {
//       try {
//         const pageBreakIds: string[] = (window as any).__resumePageBreakIds || [];
