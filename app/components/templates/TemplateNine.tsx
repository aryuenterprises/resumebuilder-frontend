...
const TemplateNine: React.FC<TemplateNineProps> = ({
  ...
  const buildCSS = useCallback(
    ...
    *, *::before, *::after { box-sizing: border-box; }
    ...
    .t9-resume p { margin: 0 !important; padding: 0 !important; line-height: 1.5 !important; }
    ...
    @media print {
      *, *::before, *::after { -webkit-print-color-adjust: exact !important; print-color-adjust: exact !important; }
      ...
      .t9-resume .header-banner { -webkit-print-color-adjust: exact; print-color-adjust: exact; }
      .t9-resume { width: 100% !important; padding: 0 !important; }
      .project-link, .header-meta-row a { color: #cccccc !important; text-decoration: underline !important; }
  ...
  const generateHTML = useCallback(
    ...
    `
      ...
      <div class="section-block" data-block-id="exp-section">
        ...
        ${experiences
          .map((exp: any, i: number) => {
            exp.endDate ? formatMonthYear(exp.endDate, false) : "Present";
            const startFormatted = formatMonthYear(exp.startDate, false);
            const endFormatted = exp.endDate
              ? formatMonthYear(exp.endDate, false)
        ...
        const doMeasure = () => {
          ...
          resume
            .querySelectorAll<HTMLElement>(
              ".header-name, .header-jobtitle, .header-meta-row, .entry-title, .entry-date, .education-grade, .project-link",
            )
            .forEach((el) => {
              if (consumed.has(el)) return;
