...
// } from "@/app/(resume)/download-resume/page"; // adjust import path as needed
...
// const TemplateOne: React.FC<TemplateOneProps> = ({ alldata, customization }) => {
//   const context = useContext(CreateContext);
//   const pathname = usePathname();
...
//     };
//     return map[fontFamily] ?? map["'Poppins', sans-serif"];
//   };
...
//       const customEvent = e as CustomEvent<{ customization: ResumeCustomization }>;
//       try {
//         const pageBreakIds: string[] = (window as any).__resumePageBreakIds || [];
//         const pdfHtml = generateHTML(true, pageBreakIds);
