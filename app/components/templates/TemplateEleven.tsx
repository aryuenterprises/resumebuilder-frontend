...
//       // plus @page margin, so per-page spacing matches preview too. The old
//       // page-break-inside overrides here are gone — they're meaningless now
//       // that breaks come from precomputed line-level cut points, not CSS
//       // break hints.
//       const pdfOverrideStyle = forPDF
//         ? `<style>
//             @page { size: A4; margin: 0; }
//             html, body { margin: 0 !important; padding: 0 !important; }
//             .t11-resume { width: ${A4_W}px !important; padding: 0 ${MARGIN}px !important; }
//           </style>`
//         : "";
...
//   // ── Page splitter (TemplateOne's line-level engine, adapted for t11-*) ───
//   const splitIntoPages = useCallback(
//     (fullHtml: string): Promise<string[]> => {
//       return new Promise((resolve) => {
//         const parser = new DOMParser();
...
//   .t11-resume { width: ${A4_W}px !important; padding-left: ${MARGIN}px !important; padding-right: ${MARGIN}px !important; padding-top: 0 !important; padding-bottom: 0 !important; margin: 0 !important; box-sizing: border-box !important; }
// </style></head>
...
//   .t11-resume { width: ${A4_W}px !important; padding-top: 0 !important; padding-bottom: 0 !important; padding-left: ${MARGIN}px !important; padding-right: ${MARGIN}px !important; margin: 0 !important; }
// </style></head>
// <body>
    ...
    *, *::before, *::after { box-sizing: border-box; }
    ...
    @media print {
      *, *::before, *::after {
      ...
      .t11-resume { width: 100% !important; padding: 0 !important; }
      .project-link, .link-item { color: #2c3e50 !important; text-decoration: none !important; }
...
<body>${resumeSnapshot}</body></html>`);
        ...
        const doMeasure = () => {
          ...
          resume
            .querySelectorAll<HTMLElement>(
              ".name, .job-title, .divider, .contact-row, .address, .links, .experience-title, .experience-date, .experience-company-location, .education-degree, .education-school, .education-date, .education-grade, .project-link, .link-item",
            )
            .forEach((el) => {
              if (consumed.has(el)) return;
              pushAtomic(
                ...
                el.classList.contains("experience-title") ||
                  el.classList.contains("education-degree"),
              );
              consumed.add(el);
            });
