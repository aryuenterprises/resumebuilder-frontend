...
const Testimonial = () => {
  ...
  const Star = ({ filled }: { filled: boolean }) => (
    <FiStar
      className={`w-3 h-3 sm:w-3.5 sm:h-3.5 ${filled ? "fill-indigo-500 text-indigo-500" : "text-gray-300"}`}
    />
  );
  ...
  return (
    <section className="relative bg-white py-12 sm:py-16 lg:py-20 overflow-hidden">
      ...
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[300px] sm:w-[500px] h-[300px] sm:h-[500px] bg-indigo-50 rounded-full blur-3xl opacity-30 pointer-events-none" />
      ...
      <div className="relative px-4 sm:px-6 lg:px-8 mx-auto max-w-7xl">
        ...
        >
          <div className="inline-flex items-center gap-1.5 sm:gap-2 px-2.5 sm:px-3 py-1 sm:py-1.5 rounded-full bg-indigo-50 border border-indigo-100 mb-3 sm:mb-4">
            <BsFillChatQuoteFill className="w-3 h-3 sm:w-3.5 sm:h-3.5 text-indigo-600" />
        ...
        >
          ...
          <button
            onClick={prev}
            className="hidden md:flex absolute left-0 lg:-left-4 top-1/2 -translate-y-1/2 z-20 p-2 rounded-full bg-white shadow-lg hover:shadow-xl border border-gray-200 text-gray-600 hover:text-indigo-600 transition-all duration-300 focus:outline-none"
            aria-label="Previous testimonial"
          >
          ...
          <button
            onClick={next}
            className="hidden md:flex absolute right-0 lg:-right-4 top-1/2 -translate-y-1/2 z-20 p-2 rounded-full bg-white shadow-lg hover:shadow-xl border border-gray-200 text-gray-600 hover:text-indigo-600 transition-all duration-300 focus:outline-none"
            aria-label="Next testimonial"
          >
          ...
          <div className="flex md:hidden justify-center gap-4 mb-4">
            <button
              onClick={prev}
              className="p-2 rounded-full bg-white shadow-md border border-gray-200 text-gray-600 hover:text-indigo-600 transition-all duration-300"
              aria-label="Previous testimonial"
            >
          ...
          {/* Carousel Container */}
          <div className="relative w-full overflow-hidden px-2 sm:px-4 md:px-8 pb-5">
              ...
              >
                {visibleTestimonials.map((testimonial, idx) => (
                  <motion.div
                    ...
                    whileHover={{ y: -4 }}
                    className="group bg-white rounded-xl sm:rounded-2xl border border-gray-100 shadow-sm hover:shadow-lg transition-all duration-300 overflow-hidden"
                  >
                    {/* Quote Icon */}
                    <div className="px-4 sm:px-5 pt-4 sm:pt-5">
                      <div className="w-7 h-7 sm:w-8 sm:h-8 rounded-full bg-indigo-50 flex items-center justify-center">
                        <BsFillChatQuoteFill className="w-3.5 h-3.5 sm:w-4 sm:h-4 text-indigo-500" />
                      </div>
                    </div>
                    ...
                    <div className="p-4 sm:p-5">
                      ...
                      {/* Text */}
                      <p className="text-gray-600 text-xs sm:text-sm leading-relaxed mb-3 sm:mb-4 min-h-[60px] sm:min-h-[70px] md:min-h-[80px] line-clamp-3 sm:line-clamp-4">
                        "{testimonial.text}"
                      </p>
                      ...
                      <div className="flex items-center justify-between pt-2 sm:pt-3 border-t border-gray-100">
                        <div className="flex items-center gap-2 sm:gap-3 min-w-0 flex-1">
                          ...
                          <div className="min-w-0 flex-1">
                            <p className="font-semibold text-gray-900 group-hover:text-indigo-600 transition-colors text-xs sm:text-sm truncate">
                              {testimonial.name}
                            </p>
                        ...
                        {testimonial.linkedin && (
                          <motion.a
                            ...
                            target="_blank"
                            rel="noopener noreferrer"
                            className="flex items-center justify-center w-7 h-7 sm:w-8 sm:h-8 rounded-full bg-gray-50 hover:bg-indigo-50 transition-all duration-200 flex-shrink-0"
                            whileHover={{ scale: 1.05 }}
                            whileTap={{ scale: 0.95 }}
                            aria-label={`Connect with ${testimonial.name} on LinkedIn`}
                          >
                            <FiLinkedin className="w-3.5 h-3.5 sm:w-4 sm:h-4 text-[#0077b5]" />
                          </motion.a>
                        )}
                      </div>
                    </div>
        ...
        <div className="flex justify-center gap-1.5 sm:gap-2 mt-6 sm:mt-8">
          {Array.from({ length: Math.ceil(testimonials.length / getItemsToShow()) }).map((_, idx) => (
            <button
              key={idx}
              onClick={() => {
                setCurrentIndex(idx * getItemsToShow());
              ...
              className={`transition-all duration-300 rounded-full ${
                Math.floor(currentIndex / getItemsToShow()) === idx
                  ? "w-5 sm:w-6 h-1.5 sm:h-2 bg-indigo-600"
