        ...
        >
          ...
          <div className="flex flex-col sm:flex-row justify-center items-center gap-3 sm:gap-4 px-4 sm:px-0">
            <motion.button
              ...
              className="group w-full sm:w-auto px-5 sm:px-6 md:px-8 py-2.5 sm:py-3 text-xs sm:text-sm md:text-base font-semibold bg-white text-indigo-600 rounded-lg sm:rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 flex items-center justify-center gap-2 cursor-pointer"
            >
            ...
            <motion.button
              ...
              className="w-full sm:w-auto px-5 sm:px-6 md:px-8 py-2.5 sm:py-3 text-xs sm:text-sm md:text-base font-medium text-white border border-white/30 rounded-lg sm:rounded-xl hover:bg-white/10 transition-all duration-300 cursor-pointer"
            >
              Choose Plan
            </motion.button>
          </div>
