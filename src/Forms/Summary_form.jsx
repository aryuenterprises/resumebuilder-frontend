...
const Summary_form = forwardRef((props, ref) => {
  ...
  const fetchSummary = async () => {
    try {
      ...
      // const experienceList = response.data?.[0]?.education || [];
  ...
  return (
    ...
    //       <div className="bg-gradient-to-br from-white to-gray-50/50 rounded-2xl border border-gray-100 overflow-hidden shadow-subtle transition-all duration-300 hover:shadow-md">
    //         {/* Card Header */}
    ...
    //               disabled={loading}
    //               className={`inline-flex items-center gap-2 px-5 py-2.5 rounded-lg text-white text-sm font-medium transition-all duration-200 ${
    //                 loading
    ...
    //           {errors?.text && (
    //             <div className="flex items-center gap-2 p-3 bg-gradient-to-r from-red-50 to-red-50/50 border border-red-200 rounded-lg rounded-t-none">
    ...
    //                 </svg>
    //               </div>
    //               <p className="text-[#c40116] text-sm font-medium">
    //                 {errors.text}
    //               </p>
    //             </div>
    //           )}
    ...
    //             <div className="mb-6">
    //               <div className="bg-gradient-to-br from-gray-50 to-white rounded-xl border border-gray-200 p-4 max-h-[300px] overflow-y-auto">
    ...
    //                 className="flex-1 px-4 py-3 bg-gradient-to-r from-[#c40116] to-[#be0117] text-white font-medium rounded-lg shadow-md hover:shadow-lg transition-all flex items-center justify-center gap-2"
    //               >
