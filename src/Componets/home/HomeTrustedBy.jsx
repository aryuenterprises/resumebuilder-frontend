...
const HomeTrustedBy = () => {
  ...
  return (
    <section className="relative bg-white p-4 sm:p-6 md:p-12 lg:p-20 overflow-hidden">
      ...
      <div className="absolute -top-12 -right-12 w-48 h-48 sm:w-64 sm:h-64 md:w-80 md:h-80 lg:w-96 lg:h-96 bg-[#c40116]/5 rounded-full blur-xl sm:blur-2xl lg:blur-3xl" />
      <div className="absolute bottom-0 -left-16 w-48 h-48 sm:w-64 sm:h-64 md:w-80 md:h-80 lg:w-96 lg:h-96 bg-[#c40116]/5 rounded-full blur-xl sm:blur-2xl lg:blur-3xl" />
      ...
      <div className="relative text-center">
        ...
        <p className="mt-4 sm:mt-6 text-sm sm:text-base md:text-lg lg:text-xl text-gray-600 max-w-2xl sm:max-w-3xl mx-auto px-2 sm:px-0">
          ResumeMint helps you create stunning, ATS-friendly resumes in minutes.
        ...
        <div className="mt-8 sm:mt-10 md:mt-12 flex flex-col sm:flex-row justify-center gap-4 sm:gap-6 px-4 sm:px-0">
          <button
            ...
            className="w-full sm:w-auto px-6 sm:px-10 md:px-12 py-3 sm:py-4 rounded-xl bg-[#c40116] text-white font-bold text-sm sm:text-base md:text-lg shadow-lg hover:shadow-xl hover:-translate-y-0.5 sm:hover:-translate-y-1 transition-all duration-200 active:scale-95"
          >
          ...
          <button
            onClick={() => navigate("/choose-template")}
            className="w-full sm:w-auto px-6 sm:px-10 md:px-12 py-3 sm:py-4 rounded-xl border-2 border-slate-200 text-slate-800 font-semibold text-sm sm:text-base md:text-lg hover:border-slate-300 transition-colors duration-200"
          >
            View Templates
          </button>
        </div>
