...
const Resume7 = () => {
    ...
    return (
        <div className=" bg-white border-8 border-green-700  mt-4 mx-auto rounded-3xl" style={{
            width: "210mm",
            // height: "297mm",
            padding: "5mm",
            ...
            <div className="relative ">
                ...
                <p className='font-bold -top-5 relative ml-9 mr-6'>Human Resources Manager</p>
            </div>
            {/* body section */}
            <div className='flex gap-3 '>
                ...
                <div className='w-[70%]'> 
                    {/* summary */}
                    <div>
                        <p className='text-emerald-600 font-bold text-[17px] mb-2'>Summary</p>
                    ...
                    {/* experience */}
                    <div>
                    <p  className='text-emerald-600 font-bold text-[17px] mb-2'>Experience</p>
                    ...
                    <p className='font-bold text-[15px] text-center mt-2 mb-2'>Jim's Widget Factory, plano, TX</p>
                    ...
                    <p className='font-bold text-[15px] text-center -ml-5 mt-2 mb-2'>Acme Corp, Dallas, TX</p>
                    <p className='list-disc list-inside ml-36 space-y-1'>
                    ...
                    {/* education */}
                    <div>
                        <p className='text-emerald-600 font-bold text-[17px] mb-2'>Education</p>
                    ...
                    <p >
                        {education.map((education, index) => (
                            <p className='font-bold text-[15px] text-center mt-2 mb-2'>{education}</p>
                        ))}
                    </p>
                    </div>
                </div>
               ...
               <div className='w-[30%]'>
                {/* details */}
                <div>
                    <p className='text-emerald-600 font-bold text-[17px] mb-2'>Details</p>
                    ...
                    <div className='flex mb-1 gap-1 items-center'>
                      ...
                      <p className='text-[15px]'>New York, USA, 4759 Sunnydale Lane, Plano, TX 75071, United States</p>
                    </div>
                ...
                {/* skills */}
                <div>
                    <p className='text-emerald-600 font-bold text-[17px] mb-2'>Skills</p>
                    <p className='bg-emerald-800 mb-1 rounded-full p-3 text-white'>Detail-oriented</p>
                    <p className='bg-emerald-800 mb-1 rounded-full p-3 text-white'>Platform expertise</p>
                    <p className='bg-emerald-800 mb-1 rounded-full p-3 text-white'>Analytics</p>
                    <p className='bg-emerald-800 mb-1 rounded-full p-3 text-white'>Communication</p>
                </div>
               </div>
            </div>
