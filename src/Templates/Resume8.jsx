    ...
    <div className=" bg-white border border-gray-100 mx-auto font-nunito" style={{
      ...
      <div className='flex'>
        ...
        <div className='w-[40%]  bg-[#9dbac9] pb-1 rounded-tl-3xl p-1'>
          <p className='text-[21px] font-bold ml-3 break-words uppercase '>{contact?.firstName || ""} {contact?.lastName || ""}</p>
          ...
          <div className='flex ml-3 mb-2 gap-1 break-words items-center'>
            ...
            <p className='text-[14px] break-words'>{contact?.address
              || ""}   , {contact?.city
        ...
        <div className='w-[60%] bg-[#9dbac9] rounded-tr-3xl pb-16.5 p-2'>
          ...
          <p className="pt-2 ml-3 pb-3 text-gray-700 text-[15px] break-words
    [&_ol]:list-decimal 
    [&_ul]:list-disc 
    ...
    [&_li]:ml-4">
          ...
          {Array.isArray(finalize?.hobbiesAndInterests) &&
            finalize.hobbiesAndInterests.some(
              ...
              <div className="mt-1 ml-3">
                <p className="text-[17px] uppercase font-medium">Hobbies and Interests</p>
              ...
              {experiences?.length > 0 ? (
                experiences.map((exp, index) => (
                  <div key={exp._id || exp.id || index} className=" pb-4">
                    ...
                    <p className='text-[17px] uppercase font-medium'>Experience</p>
                    ...
                    <ul className="pt-2 ml-3 pb-3 text-gray-700 text-[15px] break-words
    [&_ol]:list-decimal 
    [&_ul]:list-disc 
    [&_li[data-list='bullet']]:list-disc 
    [&_li[data-list='ordered']]:list-decimal 
    [&_li]:ml-4">
          ...
          {Array.isArray(finalize?.awardsAndHonors) &&
            finalize.awardsAndHonors.some(
              ...
              <div className="mt-1 ml-3">
                <p className="text-[17px] uppercase font-medium">Awards and Honors</p>
                <div className="pt-2 pb-3 text-gray-700 text-[15px] break-words
    [&_ol]:list-decimal 
    [&_ul]:list-disc 
    [&_li[data-list='bullet']]:list-disc 
