  ...
  return (
    ...
    // >
      ...
      <div className="flex justify-between bg-[#878787] h-auto p-1 text-white rounded-2xl">
        <div className="w-[40%] text-[27px] font-medium p-3 uppercase break-words">
        ...
        <div className="w-[60%] p-3 text-[14px]">
          <p className="text-end break-words">
      ...
      <div>
        ...
        <p
          className="ml-5 pt-2 pb-3 text-gray-700 text-[15px] break-words
    [&_ol]:list-decimal 
    [&_ul]:list-disc 
    ...
    [&_li]:ml-4 "
      ...
      {Array.isArray(finalize?.awardsAndHonors) &&
        finalize.awardsAndHonors.some(
          ...
          <div className="mt-1">
            <h2 className="text-[22px] ml-5 mt-1">Awards and Honors</h2>
            <div
              className="pt-2 ml-5 pb-3 text-gray-700 text-[15px] break-words
    [&_ol]:list-decimal 
    [&_ul]:list-disc 
