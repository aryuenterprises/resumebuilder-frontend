        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 sm:gap-10 lg:gap-12">
          ...
          <div className="sm:col-span-2 lg:col-span-1">
            <img
              src={HeaderLogo}
              alt="ResumeMint"
              className="w-36 sm:w-40 lg:w-44 mb-4 cursor-pointer hover:opacity-90 transition-opacity"
              onClick={() => {
                navigate("/");
              }}
            />
          ...
          {/* Company */}
          <div>
            <h3 className="text-base sm:text-lg font-bold text-[#5e000b] mb-3 sm:mb-4">
              Company
            </h3>
            <ul className="space-y-1 sm:space-y-2 md:space-y-3 text-sm sm:text-base text-gray-600">
              <li>
                <button
                  ...
                  className="hover:text-[#c40116] transition-colors duration-200 text-left w-full py-1"
                >
                  Contact Us
                </button>
              </li>
            ...
            <ul className="space-y-1 sm:space-y-2 md:space-y-3 text-sm sm:text-base text-gray-600">
              <li>
                <a
                  ...
                  className="hover:text-[#c40116] transition-colors duration-200 inline-block py-1"
                >
                  Aryu Academy
                </a>
              </li>
              ...
              <li>
                <a
                  href="https://aryuenterprises.com/"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="hover:text-[#c40116] transition-colors duration-200 inline-block py-1"
                >
